            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                <div class="p-5">
                  ...
                  <h5 style="color:red">{{Session::get('karena')}}</h5>
                  </div>
                <form class="user" action="{{url('/Auth/check_auth')}}" method="POST">
                    @csrf
                    <div class="form-group">
                      <input type="username" name="email" class="form-control form-control-user" id="" aria-describedby="emailHelp" placeholder="Enter Email Address...">
                    </div>
                    <div class="form-group">
                      <input type="password" name="pwd" class="form-control form-control-user" id="" placeholder="Password">
                    </div>
